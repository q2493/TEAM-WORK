...
body(5).Ic = body(5).m * body(5).l^2 / 12;
body(6).Ic = body(6).m * body(6).l^2 / 12;
...
[t, u, v] = EulerCromer_mod_double(matrix,F_dyn, t_end, [q_0;zeros(17,1)], [zeros(size(q_0));zeros(17,1)], dt);
